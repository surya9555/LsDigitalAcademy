...
<body>
    ...
    <form action="feetype.php" method="POST">
   <div id="container2">
      <div class="main">
        <div class="header"></div>
                <div class="in" style="width: 40%;"><label for="course code">Fees Type</label>
          <input type="hidden" id="bb" name="id" required value=""></div>
          <input type="text" id="bb" name="feetype" required value=""></div>
